export const projectsData = [
  {
    title: "Sustainable Bamboo Syringe for a Green Future",
    funding: "₹10 Lakh",
    agency: "Ministry of MSME / Smart India Hackathon",
    status: "Ongoing",
    type: "Medical Device / Green Technology",
    awardBadge: "MSME Idea Hackathon 4.0 Winner"
  },
  {
    title: "Poultry Egg Shell Formulation for Plant and Soil Health Management",
    funding: "₹1,00,000",
    agency: "Unnat Bharat Abhiyan (UBA-SEG)",
    status: "Completed",
    type: "Agricultural Biotechnology",
  ...
  },
  {
    ...
    status: "Completed",
    type: "Biomaterials / Environmental Biotechnology",
    awardBadge: "State Innovation Grant"
  },
  {
    title: "Mushroom Cultivation and Entrepreneurship Training",
    funding: "₹4 Lakh",
    agency: "Tamil Nadu State Council for Science and Technology (TNSCST)",
    status: "Completed",
    type: "Agricultural Biotechnology / Community Skill Development",
    awardBadge: "TNSCST Grant"
  }
];
